...
import java.util.List;
    ...
    @ResponseBody
	public ResponseData update(@RequestBody List<KgAssessmentActivityUserProgress> dto, BindingResult result, HttpServletRequest request){
    ...
    @ResponseBody
    public ExtStore adminQuery(KgAssessmentActivityUserProgress dto, @RequestParam(defaultValue = DEFAULT_PAGE) int page,int start,
...
//         List<KgNews> list = service.select(requestContext,dto,1,limit);
    ...
    @ResponseBody
	public ExtAjax adminUpdate(@RequestBody List<KgAssessmentActivityUserProgress> dto, BindingResult result, HttpServletRequest request){
