Ext.namespace('addorUpdateCarousel');
addorUpdateCarousel.addorUpdateCarouselWindow = function(config) {
	Ext.applyIf(this, config);
	this.initUIComponents();
	addorUpdateCarousel.addorUpdateCarouselWindow.superclass.constructor.call(this);
};

Ext.extend(addorUpdateCarousel.addorUpdateCarouselWindow, Ext.Window, {
	...
	addorUpdateCarousel : function(me,formpanel,mainId,parentStore,id,type,isAdd) {
		...
		if( formpanel.getForm().isValid()){
			Ext.getBody().mask("数据提交中，请耐心等候...","x-mask-loading");
			  Ext.Ajax.request({
            	  url : appName + '/admin/carousel/submit',
                  method : 'post',
